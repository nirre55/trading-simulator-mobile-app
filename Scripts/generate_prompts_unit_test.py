...
def generate_prompts(directory):
    ...
    for file_path in files:
        ...
        # Générer le prompt
        prompt_content = f"""Génère des tests unitaires pour le code du projet courant dans une application React Native, en utilisant Jest et @testing-library/react-native. Produis un fichier __tests__/test_{file_name}.test.tsx, un résumé des tests, et des instructions pour configurer Jest. Le projet n’a pas encore de tests et utilise TypeScript.
