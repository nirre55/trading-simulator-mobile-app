...
describe("ResultCard", () => {
  ...
  test("rend correctement avec le type min", () => {
    ...
    render(<ResultCard type="min" iterations={6} price={50.75} />, { wrapper });
  ...
  test("rend correctement avec le type max", () => {
    ...
    render(<ResultCard type="max" iterations={7} price={45.25} />, { wrapper });
  ...
  test("rend correctement avec le thème sombre", () => {
    ...
    render(<ResultCard type="min" iterations={8} price={60.5} />, { wrapper });
  ...
  test("arrondit correctement le prix à deux décimales", () => {
    ...
    render(<ResultCard type="max" iterations={10} price={75.555} />, {
      wrapper,
    });
  ...
  test("affiche correctement le prix avec des valeurs entières", () => {
    ...
    render(<ResultCard type="min" iterations={5} price={100} />, { wrapper });
