...
describe('ErrorCard', () => {
  ...
  test('rend correctement avec un message d\'erreur', () => {
    ...
    render(
      <ErrorCard message="Une erreur est survenue" />, 
      { wrapper }
    );
  ...
  test('rend correctement avec un message long', () => {
    const longMessage = 'Ceci est un message d\'erreur très long qui devrait être affiché correctement dans le composant ErrorCard. Il est important de tester le comportement du composant avec des messages de différentes longueurs pour s\'assurer qu\'il s\'adapte correctement à tous les cas d\'utilisation.';
  ...
  test('rend correctement avec des caractères spéciaux', () => {
    ...
    render(
      <ErrorCard message={specialMessage} />, 
      { wrapper }
    );
