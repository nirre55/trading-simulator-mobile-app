...
describe("SummaryCard", () => {
  ...
  test("rend correctement avec les valeurs fournies", () => {
    ...
    render(<SummaryCard iterations={10.5} floor={10} ceil={11} targetPrice={100.42} />, {
      wrapper,
    });
  ...
  test("rend correctement avec le thème sombre", () => {
    ...
    render(<SummaryCard iterations={15.75} floor={15} ceil={16} targetPrice={200.55} />, {
      wrapper,
    });
  ...
  test("formate correctement les nombres décimaux", () => {
    ...
    render(<SummaryCard iterations={5.1} floor={5} ceil={6} targetPrice={50} />, { wrapper });
  ...
  test("gère correctement les valeurs limites", () => {
    ...
    render(<SummaryCard iterations={0} floor={0} ceil={0} targetPrice={0} />, {
      wrapper,
    });
  ...
  test("gère correctement les grandes valeurs", () => {
    ...
    expect(
      screen.getByText("Intervalle: 1000000 - 1000001 pour atteindre 9999999.99")
    ).toBeTruthy();
  });
});
