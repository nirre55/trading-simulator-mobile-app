...
const baseStyles = StyleSheet.create({
  ...
  iterationsCardHeaderWithSwitch: {
    flexDirection: "row",
    justifyContent: "space-between",
    alignItems: "center",
  },
  ...
  iterationsTableHeader: {
    flexDirection: "row",
    borderBottomWidth: 1,
    paddingBottom: 8,
  },
  iterationsTableHeaderCell: {
    flex: 1,
    paddingHorizontal: 8,
    paddingVertical: 6,
    width: 120,
  ...
  iterationsTableCell: {
    ...
    width: 120,
    alignItems: "center",
  }, // Augmenté paddingVertical pour l'espacement
...
export const getThemedStyles = (theme: ThemeType): ThemedStyles => {
  return {
    ...
    langButton: {
      ...baseStyles.langButton,
      backgroundColor: theme.colors.langButtonBackground,
    } as ViewStyle,
    langButtonActive: {
      borderWidth: 2,
      borderColor: theme.colors.langButtonActiveBorder,
    } as ViewStyle,
    langButtonText: {
      ...baseStyles.langButtonText,
      color: theme.colors.text,
    } as TextStyle,
    langButtonActiveText: {
      ...baseStyles.langButtonActiveText,
      color: theme.colors.primary,
    } as TextStyle,
    // AllocationCard
    allocationCard: {
      ...baseStyles.allocationCard,
      backgroundColor: theme.colors.card,
    ...
    dividerStyle: {
      ...baseStyles.dividerStyle,
      backgroundColor: theme.colors.border,
    } as ViewStyle,
    allocationContent: { ...baseStyles.allocationContent } as ViewStyle,
    allocationRow: { ...baseStyles.allocationRow } as ViewStyle,
    allocationLabel: {
      ...baseStyles.allocationLabel,
      color: theme.colors.secondaryText,
    } as TextStyle,
    allocationValue: {
      ...baseStyles.allocationValue,
      color: theme.colors.text,
    } as TextStyle,
    // ErrorCard
    errorCard: {
      ...baseStyles.errorCard,
      backgroundColor: theme.colors.errorCardBackground,
      borderLeftColor: theme.colors.errorCardBorder,
    } as ViewStyle,
    errorIconContainer: { ...baseStyles.errorIconContainer } as ViewStyle,
    errorTextStyle: {
      ...baseStyles.errorTextStyle,
      color: theme.colors.errorText,
    } as TextStyle,
    // ResultCard
    resultCardHalf: {
      ...baseStyles.resultCardHalf,
      backgroundColor: theme.colors.card,
      borderColor: theme.colors.border,
    } as ViewStyle,
    resultCardHeaderCenter: {
      ...baseStyles.resultCardHeaderCenter,
    } as ViewStyle,
    resultCardSubtitle: {
      ...baseStyles.resultCardSubtitle,
      color: theme.colors.text,
    } as TextStyle,
    resultIterationCount: {
      ...baseStyles.resultIterationCount,
      color: theme.colors.text,
    } as TextStyle,
    resultIterationLabel: {
      ...baseStyles.resultIterationLabel,
      color: theme.colors.secondaryText,
    } as TextStyle,
    resultPrice: {
      ...baseStyles.resultPrice,
      color: theme.colors.primary,
    } as TextStyle,
    ...
    aboutSectionTitle: {
      ...baseStyles.aboutSectionTitle,
      color: theme.colors.text,
    } as TextStyle,
    aboutSubtitle: {
      ...baseStyles.aboutSubtitle,
      color: theme.colors.secondaryText,
    } as TextStyle,
    aboutParagraph: {
      ...baseStyles.aboutParagraph,
      color: theme.colors.text,
    } as TextStyle,
    aboutUpdateItem: { ...baseStyles.aboutUpdateItem } as ViewStyle,
    aboutUpdateDate: {
      ...baseStyles.aboutUpdateDate,
      color: theme.colors.secondaryText,
    } as TextStyle,
    // Styles pour CalculatorScreen
    calculatorScrollContent: {
      ...baseStyles.calculatorScrollContent,
    } as ViewStyle,
    // Styles pour SettingsScreen
    settingsContentContainer: {
      ...baseStyles.settingsContentContainer,
    } as ViewStyle,
    settingsSection: { ...baseStyles.settingsSection } as ViewStyle,
    settingsSectionTitle: {
      ...baseStyles.settingsSectionTitle,
      color: theme.colors.text,
    } as TextStyle,
    settingsOptionContainer: {
      ...baseStyles.settingsOptionContainer,
      borderColor: theme.colors.border,
    } as ViewStyle,
    settingsOptionRow: {
      ...baseStyles.settingsOptionRow,
      borderColor: theme.colors.border,
    } as ViewStyle,
    settingsOptionInfo: {
      ...baseStyles.settingsOptionInfo,
      color: theme.colors.secondaryText,
    } as TextStyle,
    settingsOptionIcon: { ...baseStyles.settingsOptionIcon } as ViewStyle,
    // Styles pour IterationsTable
    iterationsCard: {
      ...baseStyles.iterationsCard,
      backgroundColor: theme.colors.card,
      borderColor: theme.colors.border,
    } as ViewStyle,
    iterationsCardHeaderWithSwitch: {
      ...baseStyles.iterationsCardHeaderWithSwitch,
    } as ViewStyle,
    iterationsSwitchContainer: {
      ...baseStyles.iterationsSwitchContainer,
    } as ViewStyle,
    iterationsRecoveryInfoContainer: {
      ...baseStyles.iterationsRecoveryInfoContainer,
      backgroundColor: theme.dark ? "rgba(255,255,255,0.05)" : "rgba(0,0,0,0.03)",
    } as ViewStyle,
    iterationsTableContainer: {
      ...baseStyles.iterationsTableContainer,
    } as ViewStyle,
    iterationsTableHeader: {
      ...baseStyles.iterationsTableHeader,
      borderBottomColor: theme.colors.border,
    } as ViewStyle,
    iterationsTableHeaderCell: {
      ...baseStyles.iterationsTableHeaderCell,
    } as ViewStyle,
    iterationsTableHeaderText: {
      ...baseStyles.iterationsTableHeaderText,
      color: theme.colors.text,
    } as TextStyle,
    ...
    iterationsTableCellText: {
      ...baseStyles.iterationsTableCellText,
      color: theme.colors.text,
    } as TextStyle,
    iterationsTableCellMiddle: {
      ...baseStyles.iterationsTableCellMiddle,
    } as ViewStyle,
    ...
    targetInputToggleButton: {
      ...baseStyles.targetInputToggleButton,
      backgroundColor: theme.colors.primary,
      shadowColor: theme.colors.shadow,
    } as ViewStyle,
    targetInputToggleButtonText: {
      ...baseStyles.targetInputToggleButtonText,
      color: theme.colors.buttonText,
    } as TextStyle,
  };
};
