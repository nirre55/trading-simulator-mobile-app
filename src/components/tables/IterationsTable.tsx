...
const IterationsTable: React.FC<Props> = ({ iterationDetails, allocationPerTrade, leverage }) => {
  ...
  return (
    <View style={[styles.card, styles.iterationsCard]}>
      ...
      <View style={[styles.iterationsSwitchContainer, { paddingHorizontal: 5 }]}>
        <Text style={[styles.secondaryText, { fontSize: 14 }]}>{t("tables.lossRecovery")}</Text>
        <Switch
      ...
      {isRecoveryEnabled && allocationPerTrade && (
        <View style={styles.iterationsRecoveryInfoContainer}>
          <Text style={[styles.secondaryText, { fontStyle: "italic", fontSize: 12 }]}>
            {t("tables.lossRecoveryInfo", {
              amount: roundToTwoDecimals(allocationPerTrade),
            })}
          </Text>
        </View>
      )}
        ...
        <View style={styles.iterationsTableContainer}>
          ...
          {getDetailsToDisplay().map((detail, index) => (
            ...
            >
              ...
              <View style={[styles.iterationsTableCell, styles.iterationsTableCellMiddle]}>
                <Text
                  style={[styles.iterationsTableCellText, { color: getProfitColor(detail.profit) }]}
                >
